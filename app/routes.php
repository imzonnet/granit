...
Route::get('/', function() {
    if (!Schema::hasTable('settings') || Config::get('database.default') == 'sqlite') {
        ...
        echo "Don't have permission! Database broken!";
        echo "<br /> ________________ ";
        echo "<br /> Please Install with after way:";
        echo  "<br /> 1. Configurate your database connect.";
        echo "<br /> 2. Run: composer dump-autoloadphp artisan.";
        echo "<br /> 3. Run: php artisan project:install ";
        echo "<br /> ________________ ";
        echo "<br /> JoomEXP";
    } else {
