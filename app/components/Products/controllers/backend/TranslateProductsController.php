...
class TranslateProductsController extends \BaseController {
    ...
    public function index($id) {
        ...
        $this->layout->title = 'All Translate Product Categories';
        $this->layout->content = View::make('Products::backend.translates.products.index')
    ...
    public function edit($id, $lang)
    {
        ...
        $this->layout->content = View::make('Products::backend.translates.products.create')
    ...
    public function update($id, $lang)
    {
        ...
        if (isset($input['form_close'])) {
            return Redirect::route('backend.products.translate.index', $id);
        }
        try {
