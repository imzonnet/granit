            ...
            <div class="widget light-gray box">
                ...
                <div class="widget-body">
                    <div class="clearfix margin-bottom-10">
                        <div class="btn-group pull-right">
                            <div class="actions inline">
                                ...
                                <ul class="btn">
                                    ...
                                    <li>
                                        {{ Form::open(array('route' => array($link_type . '.product-categories.destroy', 'multiple'), 'method' => 'delete', 'class'=>'inline', 'onsubmit'=>"return deleteRecords($(this), 'product-categories');")) }}
                        ...
                        @if ($current_user->hasAccess("product-categories.create"))
                        <div class="btn-group pull-right">
                            <button data-href="{{ URL::to($link_type . '/product-categories/create') }}" class="btn btn-success">
                        ...
                        @foreach( $categories as $category )
                            <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('backend.product-categories.translate.index', $category->id)  }}" class="btn btn-mini"><i class="icon-plus"></i></a>
