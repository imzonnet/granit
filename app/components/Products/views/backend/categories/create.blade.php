                    ...
                    <div class="tabbable widget-tabs">
                        <div class="tab-content">
                            <div class="tab-pane active" id="widget_tab1">
                                <!-- BEGIN FORM-->
                                @if (!isset($category))
                                {{ Form::open(array('route'=>$link_type . '.product-categories.store', 'method'=>'post', 'class'=>'form-horizontal', 'files'=>true)) }}
                                @else
                                {{ Form::open(array('route' => array($link_type . '.product-categories.update', $category->id), 'method'=>'PUT', 'class'=>'form-horizontal', 'files'=>true)) }}
                                @endif
                                    ...
                                    <div class="control-group {{{ $errors->has('image') ? 'error' : '' }}}">
                                        ...
                                        <div class="controls">
                                            ...
                                            {{ Form::hidden('image', (!isset($category)) ? Input::old('image') : $category->image) }}
