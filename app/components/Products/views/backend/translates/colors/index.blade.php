                    ...
                    <table class="table table-striped table-hover table-bordered" id="sample_1">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Original</td>
                                <td>
                                    <a href="{{ route('backend.product-colors.edit', $category->id)  }}" class="btn btn-mini">Edit</a>
                                </td>
                            </tr>
                        @foreach( $languages as $id => $name )
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('backend.product-colors.translate.edit', [$category->id, $id])  }}" class="btn btn-mini">Translate</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
