        ...
        <div class="widget light-gray box">
            ...
            <div class="widget-body">
                <div class="clearfix margin-bottom-10">
                    <div class="btn-group pull-right">
                        <div class="actions inline">
                            ...
                            <ul class="btn">
                                ...
                                <li>
                                    {{ Form::open(array('route' => array($link_type . '.products.destroy', 'multiple'), 'method' => 'delete', 'class'=>'inline', 'onsubmit'=>"return deleteRecords($(this), 'products');")) }}
                    ...
                    @if ($current_user->hasAccess("products.create"))
                    <div class="btn-group pull-right">
                        <button data-href="{{ URL::to($link_type . '/products/create') }}" class="btn btn-success">
