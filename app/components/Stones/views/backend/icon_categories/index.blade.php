                        ...
                        <div class="btn-group pull-right">
                            <div class="actions inline">
                                ...
                                <ul class="btn">
                                    ...
                                    <li>
                                        {{ Form::open(array('route' => array($link_type . '.stones.icon-categories.destroy', 'multiple'), 'method' => 'delete', 'class'=>'inline', 'onsubmit'=>"return deleteRecords($(this), 'product-categories');")) }}
