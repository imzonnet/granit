                    ...
                    <div class="tabbable widget-tabs">
                        <div class="tab-content">
                            <div class="tab-pane active" id="widget_tab1">
                                <!-- BEGIN FORM-->
                                {{ Form::open(array('route' => array($link_type . '.stones.icon-categories.translate.update', $category->id, $lang), 'method'=>'PUT', 'class'=>'form-horizontal', 'files'=>true)) }}
                                    ...
                                    <div class="control-group {{{ $errors->has('description') ? 'error' : '' }}}">
                                        ...
                                        <div class="controls line">
                                           <textarea class="span12 ckeditor m-wrap" id="content" name="description" rows="6">{{ trans_get($category, $lang, 'description') }}</textarea>
