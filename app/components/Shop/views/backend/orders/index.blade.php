        ...
        <div class="span12">
            ...
            <div class="widget light-gray box">
                <div class="blue widget-title">
                    <h4><i class="icon-th-list"></i> All Orders</h4>
                    <div class="tools">
                    ...
                    <div class="clearfix margin-bottom-10">
                        <div class="btn-group pull-right">
                            <div class="actions inline">
                                ...
                                <ul class="btn">
                                    @if ($current_user->hasAccess("orders.destroy"))
                                    <li>
                                        {{ Form::open(array('route' => array($link_type . '.shop.orders.destroy', 'multiple'), 'method' => 'delete', 'class'=>'inline', 'onsubmit'=>"return deleteRecords($(this), 'product-colors');")) }}
                        ...
                        @if ($current_user->hasAccess("orders.create"))
                        <!-- <div class="btn-group pull-right">
                            <button data-href="{{ URL::to($link_type . '/shop/orders/create') }}" class="btn btn-success">
                        ...
                        <tbody>
                            <?php 
                                if( count( $orders ) > 0 ):
                                    ...
                                    ?>
                                        <tr>
                                            <td style="text-align: center">{{ Form::checkbox($o_item->id, 'checked', false) }}</td>
                                            <td style="text-align: center">{{ HTML::link( url( $link_type . '/shop/order/'.$o_item->id ), $o_item->order_code ) }}</td>
                                            <td style="text-align: center"><?php echo $o_item->status; ?></td>
                                            <td style="text-align: center"><?php echo $o_item->created_by; ?></td>
                                            <td style="text-align: center"><?php echo $o_item->customer_message; ?></td>
                                            <td style="text-align: center"><?php echo $o_item->total_price; ?></td>
                                            <td style="text-align: center"><?php echo $o_item->created_at; ?></td>
                                        </tr>
                                    <?php
                                    endforeach;
                                endif;
