...
class paypal
{
	...
	function init( $params ) 
	{
		...
		$this->config_general['API_VERSION'] 				= '109.0';
		$this->config_general['SBN_CODE'] 					= 'PP-DemoPortal-EC-IC-php';
		$this->config_general['PP_USER'] 					= $pp_user;
		$this->config_general['PP_PASS'] 					= $pp_pass;
		$this->config_general['PP_SIGNATURE'] 				= $pp_signature;
		$this->config_general['EXPRESS_MARK'] 				= true;
		$this->config_general['ADDRESS_OVERRIDE'] 			= true;
		$this->config_general['USERACTION_FLAG'] 			= false;
		$this->config_general['RETURN_URL_MARK'] 			= 'index.php';
		$this->config_general['RETURN_URL'] 				= 'index.php';
		$this->config_general['CANCEL_URL'] 				= 'index.php';
		$this->config_general['SANDBOX_FLAG'] 				= $pp_sandbox;
		$this->config_general['PP_CHECKOUT_URL_SANDBOX'] 	= 'https://www.sandbox.paypal.com/checkoutnow?token=';
		$this->config_general['PP_NVP_ENDPOINT_SANDBOX'] 	= 'https://api-3t.sandbox.paypal.com/nvp';
		$this->config_general['PP_CHECKOUT_URL_LIVE']		= 'https://www.paypal.com/checkoutnow?token=';
		$this->config_general['PP_NVP_ENDPOINT_LIVE']		= 'https://api-3t.paypal.com/nvp';

		//------------------------------//
		$this->merchantID = $this->config_general['PP_USER'];
		$this->env = ( $this->config_general['SANDBOX_FLAG'] == true ) ? 'sandbox' : 'production';
		$this->API_Endpoint = ( $this->config_general['SANDBOX_FLAG'] == true ) ? $this->config_general['PP_NVP_ENDPOINT_SANDBOX'] : $this->config_general['PP_NVP_ENDPOINT_LIVE'];
		$this->PAYPAL_URL = ( $this->config_general['SANDBOX_FLAG'] == true ) ? $this->config_general['PP_CHECKOUT_URL_SANDBOX'] : $this->config_general['PP_CHECKOUT_URL_LIVE'];
	...
	*/
	function CallShortcutExpressCheckout( $paramsArray, $returnURL, $cancelURL) 
	{
		...
		$nvpstr = $nvpstr . "&L_PAYMENTREQUEST_ORDER_ID=". $paramsArray["order_id"];
	...
	*/
	function hash_call( $methodName, $nvpStr )
	{
		...
		$version = $this->config_general['API_VERSION'];
		$API_UserName = $this->config_general['PP_USER'];
		$API_Password = $this->config_general['PP_PASS'];
		$API_Signature = $this->config_general['PP_SIGNATURE'];
		$sBNCode = $this->config_general['SBN_CODE']; 
	...
	*/
	function RedirectToPayPal ( $token )
	{
		...
		if( isset( $_SESSION['EXPRESS_MARK'] ) && ( $_SESSION['EXPRESS_MARK'] == 'ECMark' ) ){
			$payPalURL = $payPalURL. '&useraction=commit';
		} else {
			if( $this->config_general['USERACTION_FLAG'] )
				$payPalURL = $payPalURL. '&useraction=commit';	
		}
