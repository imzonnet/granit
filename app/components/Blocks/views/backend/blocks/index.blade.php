        ...
        <div class="widget light-gray box">
            ...
            <div class="widget-body">
                <div class="clearfix margin-bottom-10">
                    <div class="btn-group pull-right">
                        <div class="actions inline">
                            ...
                            <ul class="btn">
                                ...
                                <li>
                                    {{ Form::open(array('route' => array($link_type . '.block.destroy', 'multiple'), 'method' => 'delete', 'class'=>'inline', 'onsubmit'=>"return deleteRecords($(this), 'blocks');")) }}
                    ...
                    <div class="btn-group pull-right">
                        <button data-href="{{ URL::to($link_type . '/block/create') }}" class="btn btn-success">
                ...
                <table class="table table-striped table-hover table-bordered" id="sample_1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ Form::checkbox($block->id, 'checked', false) }}</td>
                            <td>{{ $block->info }}</td>
                            <td>{{ $block->region }}</td>
                            <td>{{ $block->status }}</td>
                            <td>
                                <a href="{{ URL::to($link_type . '/block/' . $block->id . '/edit') }}" class="btn btn-mini"><i class="icon-edit"></i></a>
                                <a href="{{ URL::route('backend.block.translate.index', $block->id) }}" class="btn btn-mini">Translate</a>
                                <div class="actions inline">
