        ...
        <div class="widget light-gray box">
            ...
            <div class="widget-body">
                ...
                <table class="table table-striped table-hover table-bordered" id="sample_1">
                    ...
                    <tbody>
                        @foreach( $translates as $block )
                        <tr>
                            <td>{{ Form::checkbox($block->id, 'checked', false) }}</td>
                            <td>{{ $block->title }}</td>
                            <td>{{ $block->language }}</td>
                            <td>
                                <a href="{{ URL::route('backend.block.translate.edit', [$block->block_id, $block->id]) }}" class="btn btn-mini"><i class="icon-edit"></i></a>
                                <div class="actions inline">
